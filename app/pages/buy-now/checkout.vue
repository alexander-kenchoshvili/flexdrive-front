...
const checkoutTotal = computed(() =>
  (
    Number(buyNowStore.total || 0) + Number(deliveryPrice.value || 0)
  ).toFixed(2),
);
          ...
          >
            ...
            >
              ...
              <BaseButton
                ...
                :disabled="
                  submitPending || buyNowStore.mutating || !deliveryQuoteReady
                "
