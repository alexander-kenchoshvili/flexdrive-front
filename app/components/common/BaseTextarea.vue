...
const textareaClasses = computed(() => {
  const base =
    "w-full rounded-lg border bg-surface px-3 py-3 text-sm leading-6 text-text-primary placeholder:text-text-muted shadow-[0_1px_0_rgba(17,24,39,0.03)] transition-[border-color,background-color,box-shadow] duration-200 ease-out disabled:cursor-not-allowed disabled:bg-bg-muted disabled:text-text-muted disabled:opacity-80 focus:bg-surface focus:outline-none focus-visible:outline-none";
