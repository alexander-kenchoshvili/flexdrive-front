...
type PrivacyPolicyData = SmartComponentRenderData & {
...
const sectionTitle = computed(
  () => sanitizeText(props.data?.title) || "კონფიდენციალურობის პოლიტიკა",
);
...
const sections = computed<PrivacyPolicySection[]>(() =>
  rawItems.value
    .map((item, index) => {
      ...
      return {
        ...
        anchorId: `privacy-section-${position}`,
    ...
    <div class="container-fluid relative">
      ...
      >
        ...
        <div class="px-5 py-6 md:px-8 md:py-8 lg:px-10">
          ...
          >
            კონფიდენციალურობის სექციები ჯერ არ არის დამატებული.
          </div>
        </div>
      </div>
