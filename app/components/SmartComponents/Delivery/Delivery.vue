...
type DeliveryData = SmartComponentRenderData & {
...
const sectionTitle = computed(
  () => sanitizeText(props.data?.title) || "მიწოდების პირობები",
);
  ...
  rawItems.value
    .map((item, index) => {
      ...
      return {
        ...
        anchorId: `delivery-section-${position}`,
    ...
    <div class="container-fluid relative">
      ...
      >
        ...
        <div class="px-5 py-6 md:px-8 md:py-8 lg:px-10">
          ...
          >
            მიწოდების სექციები ჯერ არ არის დამატებული.
          </div>
        </div>
      </div>
