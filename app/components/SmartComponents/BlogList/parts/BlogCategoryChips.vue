...
<template>
  <div class="blog-category-chip-strip -mx-1 flex gap-2 overflow-x-auto px-1 pb-2 pt-1">
    <button
      type="button"
      :disabled="disabled"
      :class="[
        'shrink-0 rounded-md border px-3 py-1.5 text-[13px] font-bold transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-60 md:px-4 md:py-2 md:text-sm',
