...
type ReturnsData = SmartComponentRenderData & {
...
const sectionTitle = computed(
  () => sanitizeText(props.data?.title) || "დაბრუნება და თანხის დაბრუნება",
);
...
const sections = computed<ReturnsSection[]>(() =>
  rawItems.value
    .map((item, index) => {
      ...
      return {
        ...
        anchorId: `returns-section-${position}`,
    ...
    <div class="container-fluid relative">
      ...
      >
        ...
        <div class="px-5 py-6 md:px-8 md:py-8 lg:px-10">
          ...
          >
            დაბრუნების სექციები ჯერ არ არის დამატებული.
          </div>
        </div>
      </div>
